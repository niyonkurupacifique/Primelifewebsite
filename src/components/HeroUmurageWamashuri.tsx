  ...
  const slides = [
    {
      ...
      subtitle: "Education Insurance - Taken by a parent, future parent or guardian to paying for children's education in the future",
      button: "Buy Umurage w'Amashuri",
...
export default HeroUmurageWamashuri
