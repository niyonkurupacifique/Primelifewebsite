  ...
  const slides = [
    {
      ...
      subtitle: "speciﬁcally designed for moto bike riders, drivers and whoever conducts vehicles.",
      button: "Buy Nkunganire Insurance",
      image: "./familyinsurancephoto.jpeg",
    }
    // {
    //   id: 2,
...
export default HeroNkunganireInsurance
