      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div style={{border:'1px'}} className="bg-white rounded-lg  p-6 border  border-gray-200">
          ...
          <div className="flex items-start space-x-3 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Prime Loan Protection Insurance gives you peace of mind that your outstanding payments will be settled in case of the following events: <span>   </span>

                   <span className=' text-black font-bold'>Death ,</span> 
                   <span className='text-black font-bold'>Total permanent disability ,</span> 
                  <span className='text-black font-bold'>Critical illness ,
                    Retrenchment</span> 
            </p>
          </div>
