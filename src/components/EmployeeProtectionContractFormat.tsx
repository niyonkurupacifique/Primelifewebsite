  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="text-center mb-12">
        <h1  className="text-3xl font-bold text-[#00AFF3] mb-4">Employee Protection Contract Format:</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
        {languages.map((language) => (
          <div 
            key={language.code} 
            className=" rounded-lg shadow-md p-8  border border-slate-300 hover:shadow-xl transition-shadow duration-300"
          >
...
export default EmployeeContractFormat;