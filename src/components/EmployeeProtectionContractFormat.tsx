...
const EmployeeContractFormat = () => {
  ...
  const pdfPath = '/Employee_Protection.pdf';

  const proposalForms = [
   
    {
      product: 'Employee',
      url: 'https://apps.prime.rw/customerportal/files/Employee_Protection_Insurance_27_12_2023_Version_Kinyarwanda.doc.pdf',
    },
