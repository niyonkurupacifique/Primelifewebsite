...
import NkunganireShoferiSummary from './NkunganireShoferiSummary'
type Step = 1 | 2 | 3 | 4| 5

const BuyNkunganireInsuranceSteps = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className=" mx-auto px-6 py-8  w-full max-w-4xl">
        ...
        <div className="text-gray-500 text-sm ">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#00B0EF] font-medium">Nkunganire Shoferi</span>
        </div>

        {/* Title */}
        
        <h1 className="text-4xl font-bold  text-gray-900 mb-12">Buy Nkunganire Shoferi insurance.</h1>
...
export default BuyNkunganireInsuranceSteps
