...
const EducationContractFormat = () => {
  ...
  const contractFiles: Record<string, string> = {
    rw: '/Education_Kinyarwanda.pdf',
    en: '/Education_English.pdf',
    fr: '/Education_French.pdf',
  };

  const proposalForms = [
    {
      product: 'Education',
      url: 'https://apps.prime.rw/customerportal/files/Education_Insurance_27_12_2023_Version_Kinyarwanda.pdf',
    },
