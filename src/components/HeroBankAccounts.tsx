...
const HeroBankAccounts = () => {
  const [currentSlide, setCurrentSlide] = useState(0)

  const slides = [
    {
      id: 1,
      title: "Prime Life Insurance Bank Accounts",
      subtitle: "Use the following bank details or Mobile Money to make payments.",
      button: "Buy Insurance",
      image: "./background_noImage_banner.jpg",
    }
    // {
    //   id: 2,
...
export default HeroBankAccounts
