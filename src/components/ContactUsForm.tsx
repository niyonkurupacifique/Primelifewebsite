...
A new Contact Us form submission has been received with the following details:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
      ...
      const requestBody = {
        email: "info@prime.rw",
        subject: `Contact Us via Website - ${formData.fullName}`,
        body: emailBody
      };
  ...
  return (
    <form ref={formTopRef} onSubmit={handleSubmit} className="max-w-lg w-full p-6 rounded-md shadow-sm border border-[#EBEDF0]">
      <h2 className="text-xl font-semibold text-[#003366] mb-6">GET IN TOUCH WITH US</h2>
