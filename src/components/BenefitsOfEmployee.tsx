...
const BenefitsOfEmployee=()=>{
    const benefits = [
    "The policy also covers the employee’s family members.",
    "It insures against loss of income due to illness or accident.",
    "ncludes a savings feature that allows employees to grow personal funds, accessible after three years.",
            ...
            <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 sm:grid-cols-2 gap-5 mt-3">
             ...
             <div className="benefitsOfEducation  mt-3">
               <span className="font-bold text-xl bg-gradient-to-r from-[#003366] to-[#1E3A8A] bg-clip-text text-transparent  sm:text-2xl  lg:text-3xl leading-tight">
                Benefits of Employee Protection Insurance
               </span>
...
export default BenefitsOfEmployee