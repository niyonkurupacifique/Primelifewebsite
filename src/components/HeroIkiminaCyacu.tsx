  ...
  const slides = [
    {
      id: 1,
      title: "Ikimina Cyacu",
      subtitle: "Savings with Risk Insurance - Help clients to keep aside emergency funds that generate 3% annual interest",
      button: "Buy Ikimina Cyacu",
...
export default HeroIkiminaCyacu
