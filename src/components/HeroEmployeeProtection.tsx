...
const HeroEmployeeProtection = () => {
  const [currentSlide, setCurrentSlide] = useState(0)

  const slides = [
    {
      id: 1,
      title: "Employee Protection Insurance",
      subtitle: "designed for employees and it can be taken either individually or in groups.",
    ...
    //   id: 2,
    //   title: "Employee Protection Insurance",
    //   subtitle: "Providing for your children’s future",
    //   button: "Buy Education Insurance",
    //   image: "https://ext.same-assets.com/1717637306/2419902050.jpeg",
    // },
    // {
    //   id: 3,
    //   title: "Employee Protection Insurance",
...
export default HeroEmployeeProtection
