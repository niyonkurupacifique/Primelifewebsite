...
const IntegoContractFormat = () => {
  const contractFile = '/Savings_with_risk.pdf';

  const proposalForms = [
    {
      product: 'Savings (Intego)',
      url: 'https://apps.prime.rw/customerportal/files/Savings_Insurance_09_01_2025_Version_Kinyarwanda (1).pdf',
    },
  ];
        ...
        <div className="rounded-lg p-6 border border-slate-300/40 hover:shadow-xl transition-shadow duration-300">
          ...
          <ul className="space-y-3">
            <li className="flex items-center justify-between">
              <span className="text-gray-800">Savings (Intego)</span>
              <div className="flex items-center space-x-2">
                <a
                  href={contractFile}
                  target="_blank"
...
export default IntegoContractFormat;