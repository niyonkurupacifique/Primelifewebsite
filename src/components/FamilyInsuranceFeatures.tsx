  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div style={{border:'1px'}} className=" rounded-lg  p-6 border border-gray-200">
          ...
          <div className="flex items-start space-x-3 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              Single employees can replace family dependents with their parents, provided the parents are under 65 years of age.
            </p>
          </div>
          ...
          <div className="flex items-start space-x-3 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
             Married employees have the option to include both their parents and parents-in-law in the policy.
            </p>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <p className="text-gray-700 leading-relaxed">
              Adding parents or in-laws is easy with an additional premium of only 2,500 FRW per month.
            </p>
          </div>
        </div>
        ...
        {/* How it Works Card */}
        <div style={{border:'1px'}} className=" rounded-lg  p-6 border  border-gray-200">
          <h2 className="text-2xl font-bold text-[#003366] mb-6">Other Product Features</h2>
...
export default FamilyInsuranceFeatures;