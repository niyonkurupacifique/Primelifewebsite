...
const NkunganireContractFormat = () => {
  const contractFile = '/Nkunganire-Shoferi.pdf';

  const proposalForms = [
    {
      product: 'Nkunganire',
      url: 'https://apps.prime.rw/customerportal/files/Nkunganire-Shoferi_27_12_2023_Version_Kinyarwanda.doc.pdf',
    },
  ];
        ...
        <div className="rounded-lg p-6 border border-slate-300/40 hover:shadow-xl transition-shadow duration-300">
          ...
          <ul className="space-y-3">
            <li className="flex items-center justify-between">
              <span className="text-gray-800">Nkunganire Shoferi</span>
              <div className="flex items-center space-x-2">
                <a
                  href={contractFile}
                  target="_blank"
...
export default NkunganireContractFormat;
