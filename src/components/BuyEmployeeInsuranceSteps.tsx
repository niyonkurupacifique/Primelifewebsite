...
import EmployeeProtectionSummary from './EmployeeProtectionSummary'


type Step = 1 | 2 | 3 | 4| 5

const BuyEmployeeSteps = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className=" mx-auto px-6 py-8  w-full max-w-4xl">
        ...
        <div className="text-gray-500 text-sm ">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#00B0EF] font-medium">Employee Protection</span>
        </div>

        {/* Title */}
        
        <h1 className="text-4xl font-bold  text-gray-900 mb-12">Buy Employee Protection Insurance.</h1>
...
export default BuyEmployeeSteps
