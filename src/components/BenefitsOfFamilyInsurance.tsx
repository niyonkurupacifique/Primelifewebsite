...
const BenefitsOfFamilyInsurance=()=>{
    const benefits = [
    "With family insurance the subscriber takes out ﬁnancial worry for last expenses.",
    "Subscribers cover their beloved ones from risks and save funds for future emergency.",
    "Provides peace of mind knowing your family is financially protected at all times."
  ]
...
export default BenefitsOfFamilyInsurance